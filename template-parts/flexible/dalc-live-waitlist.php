...
$submit_label       = trim((string) (get_sub_field('submit_label') ?: 'Join the DALC Live Waitlist'));
...
$form_id = 'elahub-dalc-live-waitlist-' . get_the_ID() . '-' . wp_unique_id();
			...
			<div class="flex flex-col gap-8">
				...
				<div class="flex flex-col gap-6">
					...
					<?php if ($section_heading) : ?>
						<h2 class="!mb-0 max-w-[20ch]" id="<?php echo esc_attr($form_id); ?>-heading"><?php echo esc_html($section_heading); ?></h2>
					<?php endif; ?>

					<?php if ($section_body) : ?>
						<div class="elahub-feature__body elahub-rich-text max-w-[70ch]">
				...
				<div class="elahub-form">
					<form
						...
						<input type="hidden" name="_form_label"          value="DALC Live Waitlist">
